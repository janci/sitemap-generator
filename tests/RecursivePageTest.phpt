...
class RecursivePageTest extends TestCase {
    ...
    public function testHomepage(){
        ...
        $siteMap->scanSite(StringScanDriver::fromUrl("http://test.sk/"), true);
        ...
        Assert::true($siteMap->getScanTime()*1000 < 30);
    }
    ...
    public function testPageNo1(){
        ...
        $siteMap = new SitemapGenerator();
        $siteMap->scanSite(StringScanDriver::fromUrl("http://test.sk/page-no-1.html"), true);
        $urls = $siteMap->getFoundUrls();
